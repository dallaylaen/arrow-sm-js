...
(function(window){
    ...
    */
    function ArrowSM(dsl = {}) {
        ...
        *   This is basically the same as providing corresponding fields in addState.
        */
        ...
        *   @desc
        *   Set the state to start from if <tt>start()</tt>
        ...
        *   @param {ArrowSM~ValidState} [initialState]
        *   May be omitted if initialState(...) was called before.
